<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="ItemRequestAuthorisation.aspx.cs" Inherits="ItemRequestAuthorisation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" Runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">
                    Item Request Authorisation<span class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
        ...
        <div class="row-fluid">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left">
                                                                 <asp:DropDownList ID="ddlsattusforSearch" runat="server" AutoPostBack="True" CssClass="chzn-select"
                                                                    ...
                                                                    <asp:ListItem Value="2">Authorised</asp:ListItem>
                                                                    <asp:ListItem Value="3">Rejected At Authorisation</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                    </table>
            ...
            <div id="div_student" visible="false" runat="server">
                <div class="widget-box">
                    <div class="widget-header widget-header-small header-color-dark">
                        <h5>
                          Item Request Authorisation for Student
                        </h5>
                        ...
                        <div class="widget-body-inner">
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <asp:DataList ID="datalist_Student" CssClass="table table-striped table-bordered table-hover"
                                            ...
                                            <ItemTemplate>
                                                   ...
                                                   <td style="text-align: center;">
                                                    <asp:Label ID="Label31" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Source_Center_Name")%>' />
                                                </td>
                                                ...
                                                <td style="text-align: left;">
                                                 ...
                                                 <td style="text-align: left;">
                                                    <asp:Label ID="Label26" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"status")%>' />
                                                </td>
                                                <td style="text-align: left;">
                                                    ...
                                                    <table cellpadding="0" class="table-hover" style="border-style: none;" width="100%">
                                                        <tr>
                                                            ...
                                                            <td class="span4" style="border-style: none; text-align: left; width: 60%;">
                                                                ...
                                                                <span id="Flag_StudAuthorised" runat="server" visible="false" class="label label-important arrowed">
                                                                Authorised</span>
                                                            </td>
                                                        </tr>
                                                    </table>
                            ...
                            <div class="widget-main alert-block alert-info" style="text-align: center;">
                                <asp:Button class="btn btn-app btn-primary  btn-mini radius-4" runat="server" ID="btnSave_ForStudent"
                                    Text="Save" ToolTip="Save" ValidationGroup="UcValidateSearch" 
                                    onclick="btnSave_ForStudent_Click" />
                                <asp:Button class="btn btn-app btn-grey btn-mini radius-4" ID="btnClose_FotStudent"
                                    Visible="true" runat="server" Text="Close" 
                                    onclick="btnClose_FotStudent_Click"  />
            ...
            <div id="div_Teacher" visible="false" runat="server">
                <div class="widget-box">
                    <div class="widget-header widget-header-small header-color-dark">
                        <h5>
                             Item Request Authorisation for Teacher
                        </h5>
                    </div>
                    <div class="widget-body">
                        <div class="widget-body-inner">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <table cellpadding="2" class="table table-striped table-bordered table-condensed">
                                            ...
                                            <div class="widget-box">
                                         <div class="table-header" id="Div1" runat="server">
                                           <table width="100%" >
                                            <tr>
                                                <td class="span10">
                                                    Total No of Records:
                                                    <asp:Label runat="server" ID="lbltotalteacher" Text="0" />
                                                </td>
                                                <td style="text-align: right" class="span2">
                                                    ...
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 80%;">
                                                                <asp:TextBox ID="TxtRemarks_ForTeacher" runat="server" TextMode="MultiLine" 
                                                    ...
                                                    <table cellpadding="0" class="table-hover" style="border-style: none;" width="100%">
                                                        <tr>
                                                            ...
                                                            <td class="span4" style="border-style: none; text-align: left; width: 60%;">
                                                                ...
                                                                <span id="Flag_AuthTeacher" runat="server" visible="false" class="label label-important arrowed">
                                                                Authorised</span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            ...
                                                            <td class="span4" style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:Label runat="server" ID="lblStudApproved1" CssClass="blue" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:Label runat="server" ID="lblstudApprovedOn1" class="blue"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:Label runat="server" ID="lblStudentLevelRemark1" CssClass="blue" />
            ...
            <div id="div_Employee" visible="false" runat="server">
                <div class="widget-box">
                    <div class="widget-header widget-header-small header-color-dark">
                        <h5>
                      Item Request Authorisation for Employee
                        </h5>
                    </div>
                    <div class="widget-body">
                        <div class="widget-body-inner">
                                                    ...
                                                    <table cellpadding="0" class="table-hover" style="border-style: none;" width="100%">
                                                        <tr>
                                                            ...
                                                            <td class="span4" style="border-style: none; text-align: left; width: 60%;">
                                                                ...
                                                                <span id="Flag_AuthEmployee" runat="server" visible="false" class="label label-important arrowed">
                                                                Authorised</span>
                                                            </td>
                                                        </tr>
                                                    </table>
