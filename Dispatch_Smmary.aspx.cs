...
public partial class Dispatch_Smmary : System.Web.UI.Page
{
    ...
    private void FillGrid(string fromdate, string todate, string From_Location_Type_Code, string From_Location_Code)
    {
        try
        {
            ...
            DataSet dsGrid = ProductController.Get_Dispatch_summary(fromdate, todate, From_Location_Type_Code, From_Location_Code);
