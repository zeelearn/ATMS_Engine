...
namespace ShoppingCart.BL
{
    public class AccountController
    {
       ...
       string Doc_type, int Flag, string Stream, string Materialtype, string orderid)
        ...
        //For Enquiry
        public static DataSet GetStudent_ForEnquiryFromOpp(string StudentName,string DivisionCode,string CenterCode,string ProductCode,string SBEntryCode,string AppNo,string UserCode)
        {
            SqlParameter p1 = new SqlParameter("@StudentName", StudentName);
            ...
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "Usp_Get_OppStudent_SMS_Enquiry", p1,p2,p3,p4,p5,p6,p7));
        }
