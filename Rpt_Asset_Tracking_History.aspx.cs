...
public partial class Rpt_Asset_Tracking_History : System.Web.UI.Page
{
    ...
    private void FillGrid(string fromdate, string todate, string From_Location_Type_Code, string From_Location_Code)
    {
        try
        {
            ...
            DataSet dsGrid = ProductController.Asset_TrackingHistory_Report(fromdate, todate, From_Location_Type_Code, From_Location_Code,txtatms_assetno.Text);
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='12'>Asset Tracking History Report</b></TD></TR>");
        Response.Charset = "";
