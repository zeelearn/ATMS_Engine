<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DispatchRequest_Print.aspx.cs" Inherits="DispatchRequest_Print" %>
                        ...
                        <div class="wrapper">
                          ...
                          <div class="header_info">
                              ...
                              <asp:Label ID="Label6" runat="server" CssClass="red" Font-Bold="False" Font-Size="X-Large">Neptune's Flying Colors,Near Check Naka Bus Depot,</asp:Label><br />
                                    ...
                                    Font-Size="Large" Font-Underline="True">Delivery Challan</asp:Label>
                          </div>
	                        ...
	                        <%--<div class="table">--%>
                                    ...
                                    <table cellpadding="0" style="border-style: none; width: 100%;" class="table-hover">
                                        <tr>
                                            ...
                                            <td style="border-style: none; text-align: left; width: 23%;">
                                            ...
                                            <td style="border-style: none; text-align: left; width: 25%;">
                                             ...
                                             <td style="border-style: none; text-align: left; width: 25%;">
                                                <asp:Label ID="Label12" Text="Received By" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                       <%-- <tr>
