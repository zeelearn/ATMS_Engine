...
public partial class Stock_Report : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            DataSet dsGrid = ProductController.Get_Report_StockDetails(1, ddlLocationType.SelectedValue.ToString(), Transfer_LocationCode, FromDate, ToDate);
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='6'>Stock Reoprt</b></TD><TR><TD Colspan='3'><b>Location Type : " + lblLocationType_Result.Text + "</b></TD><TD Colspan='3'><b>Location : " + lblLocationResult.Text + "</b></TD></tr><tr><TD Colspan='3'><b>Period : " + lblPeroidResult.Text + "</b></TD></TR></TR>");
        Response.Charset = "";
