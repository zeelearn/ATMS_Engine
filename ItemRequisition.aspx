<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="ItemRequisition.aspx.cs" Inherits="ItemRequisition" %>
...
//      function check() {
    $(function () {
        ...
        $("#tblCustomers [id*=chkAttendanceAll]").click(function () {
            if ($(this).is(":checked")) {
                $("#tblCustomers [id*=chkCheck]").attr("checked", "checked");
            } else {
                $("#tblCustomers [id*=chkCheck]").removeAttr("checked");
            }
        });
        $("#tblCustomers [id*=chkRow]").click(function () {
            if ($("#tblCustomers [id*=chkCheck]").length == $("#tblCustomers [id*=chkCheck]:checked").length) {
                $("#tblCustomers [id*=chkAttendanceAll]").attr("checked", "checked");
            } else {
                $("#tblCustomers [id*=chkAttendanceAll]").removeAttr("checked");
            }
        });
    });
    //        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">
                    Item Requisition<span class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="span4" style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList ID="ddlClassrmProd_frStud" runat="server" AutoPostBack="True" CssClass="chzn-select"
                                                                    data-placeholder="Select ClassRoom Product" Width="215px" OnSelectedIndexChanged="ddlClassrmProd_frStud_SelectedIndexChanged" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <table cellpadding="2" runat="server" visible="false" class="table table-striped table-bordered table-condensed">
                                                ...
                                                <asp:Repeater ID="datalist_Student" runat="server" OnItemCommand="dlGridDisplay_ItemCommand">
                                                    <HeaderTemplate>
                                                        <table id="tblCustomers" class="table table-striped table-bordered table-hover Table2">
                                                            <thead>
                                                                <tr>
                                                                    <th>
                                                                      <%--  <asp:CheckBox ID="chkAttendanceAll" runat="server" />--%>
                                                                        <asp:CheckBox ID="chkAttendanceAll" runat="server" AutoPostBack="True" OnCheckedChanged="chkAttendanceAll_CheckedChanged" />

                                                                        <span class="lbl"></span>
                                                                 <%--       <asp:CheckBox ID="chkAttendanceAll" runat="server" AutoPostBack="True" Text="yes" onclick="calculateSum();" />--%>
                                                                 <%--<asp:CheckBox ID="chkAttendanceAll" runat="server" AutoPostBack="True" OnCheckedChanged="chkAttendanceAll_CheckedChanged" />--%>
                                                                 <%--<asp:CheckBox ID="chkAttendanceAll" runat="server" OnClick="check();" />--%>
                                                                    </th>
                                                                    <th>
                                                                        SBEntrycode
                                                                    </th>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            <td>
                                                                <asp:CheckBox ID="chkCheck" runat="server" Visible='<%# Convert.ToString(DataBinder.Eval(Container.DataItem,"Item_Issued")) == "0" ? true : false%>' />
                                                                <span class="lbl"></span>
                                                            </td>
                                                            <td>
                            ...
                            <div class="widget-main">
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <div class="widget-box">
                                            <div class="table-header" id="divteacher" runat="server" visible="false">
                                                <table width="100%">
                                                    <tr>
                                                        <td class="span10">
                                                            Total No of Records:
                            ...
                            <div class="widget-main">
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                    ...
                                    <Triggers>
                                        ...
                                        <asp:PostBackTrigger ControlID="btnshow_ForTeacher" />
                                    </Triggers>
                                </asp:UpdatePanel>
                            </div>
                            <div class="widget-main alert-block alert-info" style="text-align: center;">
