...
public partial class ScrapDetail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblHeader.Text = "Scrap Detail";
            
            //NewPageLoad(opt);

            ControlVisibility("Search");
            FillDDL_TransferType();
           // FillDDL_TransferTypeTo();
            FillDDL_Division();
            FillDDL_Godown();
            FillDDL_Function();
            FillDDL_Logistic();
    ...
    //private void FillDDL_TransferTypeTo()
    //{
    //    //Search DDL
    //    DataSet dsTransfer_Tp = ProductController.GetAllTransferType(17);        
    ...
    //    BindDDL(ddlVendorAdd, dsSupplier, "Vendor_Name", "Vendor_Id");
    //    ddlVendorAdd.Items.Insert(0, "Select");
    //    ddlVendorAdd.Items.Insert(dsSupplier.Tables[0].Rows.Count + 1, "Other");
    ...
    private void SaveData()
    {
      ...
      Dispatch_Date, Challan_No, Challan_Date, ContactPerson, ContactPersonNo, "", Total_Item_Count
     , Total_Quantity, Total_Amount, 1, LogisticType_Code, LogisticDetails1, LogisticDetails2, IsActive, CreatedBy, "", "6", Vendor, Narration);
                ...
                foreach (DataListItem item in DataList2.Items)
                {
                    if (item.ItemType == ListItemType.Item | item.ItemType == ListItemType.AlternatingItem)
                    {
                        ...
                        string a = ProductController.Insert_Update_DispachItemop05(ResultId, lblItem_Code_DT.Text, lblAssetNo_DT.Text, Convert.ToInt32(lblQty_DT.Text), Convert.ToDecimal(lblUnitPrice_DT.Text), Convert.ToDecimal(lblAmount_DT.Text), lblInward_Code.Text.Trim(), lblInwardEntry_Code_DL.Text.Trim(), "");
                                ...
                                if (a != "1")
                                {
                                    string b = ProductController.ItemScrapAuthorisation_ForFlat(ResultId, lblInward_Code.Text, lblItem_Code_DT.Text, lblInwardEntry_Code_DL.Text, a, lblBarcode_DT.Text, lblAssetNo_DT.Text, From_Location_Type_Code, From_Location_Code, From_Location_Type_Code, From_Location_Code, DateTime.Now, iQty, Convert.ToDecimal(lblUnitPrice_DT.Text), Convert.ToInt32(lblQty_DT.Text), Convert.ToDecimal(lblAmount_DT.Text), UserID);
    ...
    private void UpdateData()
    {
        try
        {
            ...
            //, Total_Quantity, Total_Amount, 1, LogisticType_Code, LogisticDetails1, LogisticDetails2, IsActive, CreatedBy, "", "6");


            ResultId = ProductController.Insert_Update_Dispachop4(21, lblPkey.Text, From_Location_Type_Code, From_Location_Code, Dispatch_Date, Challan_No, Challan_Date, ContactPerson, ContactPersonNo, "", Total_Item_Count
                       , Total_Quantity, Total_Amount, 1, LogisticType_Code, LogisticDetails1, LogisticDetails2, IsActive, CreatedBy, "", "6", Vendor,Narration);
                ...
                foreach (DataListItem item in DataList2.Items)
                {
                    if (item.ItemType == ListItemType.Item | item.ItemType == ListItemType.AlternatingItem)
                    {
                       ...
                       // string a = ProductController.Insert_Update_DispachItem(lblPkey.Text, lblItem_Code_DT.Text, lblAssetNo_DT.Text, Convert.ToInt32(lblQty_DT.Text), Convert.ToDecimal(lblUnitPrice_DT.Text), Convert.ToDecimal(lblAmount_DT.Text), lblInward_Code.Text.Trim(), lblInwardEntry_Code_DL.Text.Trim(), lblDispatchEntry_Code.Text.Trim());
                        ...
                        if (a != "1")
                        {
                            string b = ProductController.ItemScrapAuthorisation_ForFlat(lblPkey.Text, lblInward_Code.Text, lblItem_Code_DT.Text, lblInwardEntry_Code_DL.Text, a, lblBarcode_DT.Text, lblAssetNo_DT.Text, From_Location_Type_Code, From_Location_Code, From_Location_Type_Code, From_Location_Code, DateTime.Now, iQty, Convert.ToDecimal(lblUnitPrice_DT.Text), Convert.ToInt32(lblQty_DT.Text), Convert.ToDecimal(lblAmount_DT.Text), UserID);
    ...
    private void SaveDataForOptionCode(string UserType)
    {
        try
        {
            ...
            , To_Location_Code, "", "", "", "",
            //Dispatch_Date, Challan_No, Challan_Date, 
            ContactPerson, ContactPersonNo, "", Total_Item_Count
            , Total_Quantity, Total_Amount, 1, LogisticType_Code, LogisticDetails1, LogisticDetails2, IsActive, CreatedBy, "", opt, Narration,"","","","","","");
                ...
                if (opt == "2")
                {
                    ...
                    foreach (DataListItem item in DataList2.Items)
                    {
                        if (item.ItemType == ListItemType.Item | item.ItemType == ListItemType.AlternatingItem)
                        {
                         ...
                         //   string a = ProductController.Insert_Update_DispachItem(ResultId, lblItem_Code_DT.Text, lblAssetNo_DT.Text, Convert.ToInt32(lblQty_DT.Text), Convert.ToDecimal(lblUnitPrice_DT.Text), Convert.ToDecimal(lblAmount_DT.Text), lblInward_Code.Text.Trim(), lblInwardEntry_Code_DL.Text.Trim(), "");

                          //  if (a != "1")
                           // {
                            //    string b = ProductController.DispatchAuthorisation_ForFlat(ResultId, lblInward_Code.Text, lblItem_Code_DT.Text, lblInwardEntry_Code_DL.Text, a, lblBarcode_DT.Text, lblAssetNo_DT.Text, To_Location_Type_Code, To_Location_Code, From_Location_Type_Code, From_Location_Code, DateTime.Now, iQty, Convert.ToDecimal(lblUnitPrice_DT.Text), Convert.ToInt32(lblQty_DT.Text), Convert.ToDecimal(lblAmount_DT.Text));
                ...
                else if (opt == "3")
                {
                    ...
                    foreach (DataListItem item in DTOP3.Items)
                    {
                        if (item.ItemType == ListItemType.Item | item.ItemType == ListItemType.AlternatingItem)
                        {
                            ...
                            //if (a != "1")
                            //{
                            //    string b = ProductController.DispatchAuthorisation_ForFlat(ResultId, lblInward_Code.Text, lblItem_Code_DT.Text, lblInwardEntry_Code_DL.Text, a, lblEANNo_DT.Text, lblAssetNo_DT.Text, To_Location_Type_Code, To_Location_Code, From_Location_Type_Code, From_Location_Code, DateTime.Now, iQty, 0, iQty, 0);

                            //    Resultop4 = ProductController.Insert_DispatchEntry_ReuestEntry_COdeOP3(1, ResultId, a, "", lblRequestEntry_Code_Grid.Text.Trim());
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (ddlTransferFR_SR.SelectedValue == "Select Location Type")
        {
       ...
       // To_Location_Type_Code = ddlTransferTO_SR.SelectedValue;
        ...
        if (opt == "2" || opt == "3")
        {
            ds = ProductController.Get_Dispatch_Item(15, Challan_No, From_Location_Type_Code, From_Location_Code, To_Location_Code, To_Location_Type_Code, FromDate, ToDate);
        }
        else
        {
            ds = ProductController.Get_Faulty_Item(22, Challan_No, From_Location_Type_Code, From_Location_Code, FromDate, ToDate, "6");
        }
                    ...
                    foreach (DataListItem item in DTOP3.Items)
                    {
                        if (item.ItemType == ListItemType.Item | item.ItemType == ListItemType.AlternatingItem)
                        {
                            ...
                            if (a != "1")
                            {
                                ...
                                Resultop4 = ProductController.Insert_DispatchEntry_ReuestEntry_COdeOP3(1, lblPkey.Text, a, "", lblRequestEntry_Code_Grid.Text.Trim());
    ...
    protected void btnSearchItem_ServerClick(object sender, EventArgs e)
    {
        ...
        opt = Request.QueryString["OptionCode"];
            ...
            dsSupplier = ProductController.GetItemForDispatchopt6(txtItemMatCode.Text.Trim(), 1, From_Location_Type_Code, From_Location_Code, "", "", Pkey2);
    ...
    protected void DataList3_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        if (e.CommandName == "comSetItem")
        {
            ...
            if (opt == "3")
            {
                ...
                dsSupplier = ProductController.GetItemForDispatch(MaterialCode, 5, From_Location_Type_Code, From_Location_Code,"", RequestEntry_Code, "");
            }
            else
            {
...
//
    ...
    protected void ddlTransferFR_Add_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //        tblTO_Division_Add.Visible = false;
        //        tblTO_Center_Add.Visible = false;
        //        tblFr_Vendor_Add.Visible = false;
        //        tblVendor_Other_Add.Visible = false;
        //    }
        //    else if (ddlTransferTO_Add.SelectedItem.ToString().Trim() == "Function")
        //    {
        //        tblTO_Function_Add.Visible = true;
        ...
        //        tblVendor_Other_Add.Visible = false;
        //    }
        //    else if (ddlTransferTO_Add.SelectedItem.ToString().Trim() == "Vendor")
        //    {
        //        tblTO_Division_Add.Visible = false;
        //        tblTO_Center_Add.Visible = false;
        //        tblTO_Function_Add.Visible = false;
        //        tblTO_Godown_Add.Visible = false;
        //        tblFr_Vendor_Add.Visible = true;
        //        tblVendor_Other_Add.Visible = false;
        //        ddlVendorAdd.SelectedIndex = 0;
        //    }
        //    else if (ddlTransferTO_Add.SelectedIndex == 0 || ddlTransferTO_SR.SelectedIndex == -1)
    ...
    //{
    //    if (ddlVendorAdd.SelectedItem.ToString() == "Other")
    //    {
    //        tblVendor_Other_Add.Visible = true;
    //    }
    //    else
    //        tblVendor_Other_Add.Visible = false;
    //}
    ...
    private bool ControlValidation()
    {
        ...
        //    Flag = false;
        //}
        //else if (ddlTransferTO_Add.SelectedItem.Text == "Vendor" && ddlVendorAdd.SelectedIndex == 0)
        //{
        //    Show_Error_Success_Box("E", "Select Vendor");
        //    ddlVendorAdd.Focus();
        //    Flag = false;
        //}
        //else if (ddlTransferTO_Add.SelectedItem.Text == "Vendor" && ddlVendorAdd.SelectedValue == "Other" && txtVendorNameAdd.Text.Trim() == "")
        //{
        //    Show_Error_Success_Box("E", "Enter Vendor Name");
        //    txtVendorNameAdd.Focus();
        //    Flag = false;
        //}
    ...
    protected void txtItemQty_TextChanged(object sender, EventArgs e)
    {
        ...
        if (double.TryParse(txtItemQty.Text.Trim(), out Qty))
        {
            Qty1 = Convert.ToDecimal(txtItemQty.Text.Trim());
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        {
            Server.Transfer("Dispatch_Print.aspx?DispatchCode=" + lblPkey.Text + "&UserID=" + UserID);
        }
    ...
    protected void btnRequi_Search_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (opt == "2")
            {
                ...
                DataSet dsGrid = ProductController.Get_Data_ByRequNo("", "4", "");
                if (dsGrid != null)
                {
                    if (dsGrid.Tables[0].Rows.Count > 0)
                    {
            ...
            if (opt == "3")
            {
                ...
                DataSet dsGrid = ProductController.Get_Data_ByRequNoforOptionCode3Dispatch(ddlTransferFR_Add.SelectedValue.ToString().Trim(), From_Location_Code, "", 6);
                if (dsGrid != null)
                {
                    if (dsGrid.Tables[0].Rows.Count > 0)
                    {
    ...
    protected void ddlCenterFR_Add_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Show_Error_Success_Box("E", "Selec Division");
        ...
        {
            Show_Error_Success_Box("E", "Selec Center");
        ...
        { 
               string From_Location_Type_Code = "";
                ...
                foreach (DataListItem item in dlItemListAuthorise.Items)
                {
                    ...
                    {
                        ProductController.UpdatefaultyAcknowledgment(27, lblDispatch_code.Text, lblDispatchEntry_Code.Text, UserID);
                    }
                }
