...
public partial class Report_StockSummary : System.Web.UI.Page
{
    #region PageLoad
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Rpt_stocksummary_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='10'>Reoprt Stock_Summary Details</b></TD><TR><TD Colspan='3'><b>Location Type : " + lblLocationType_Result.Text + "</b></TD><TD Colspan='3'><b>Location : " + lblLocationResult.Text + "</b></TD></tr><tr><TD Colspan='3'><b>Period : " + lblPeriod.Text + "</b></TD><TD Colspan='3'><b>Supplier : " + lblItemName.Text + "</b></TD></TR></TR>");
        Response.Charset = "";
