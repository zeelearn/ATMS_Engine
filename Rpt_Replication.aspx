<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Rpt_Replication.aspx.cs" Inherits="Rpt_Replication" %>
                                            ...
                                            <tr>
                                                ...
                                                <td class="span4" style="text-align: left">
                                                  <%--  <table cellpadding="0"  style="border-style: none; width: 100%;" class="table-hover">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label2" runat="server" CssClass="red">Item Name</asp:Label>
                                                            </td>
                                                          <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList ID="ddlitem_Name" runat="server" AutoPostBack="True" CssClass="chzn-select"
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td style="text-align: right" class="span2">
                                  <%-- <asp:Button ID="btnprint" runat="server" Text="Print" class="btn-small btn-danger icon-2x icon-print-alt" />--%>
              ...
              <asp:Repeater ID="dlGridDisplay" runat="server">
                ...
                <thead>
                    ...
                    <th align="left">
                        ...
                        <th align="left">
                          Dispatch to Replication
                        </th>
                        <th align="left">
                          FG Dispatch to Stores
                        </th>
                        <th align="left">
                          FG dispatch to center
                        </th>
                        </tr>
                           </thead>
                            <tbody>
                   ...
                   <tr class="odd gradeX">
                    <td>
                        <asp:Label ID="lblItem_Code" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Request_Date")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="lblItem_Name" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Request_Code")%>' />
                        </td>
                      
                        <td style="text-align: left;">
                            <asp:Label ID="lblOpening_Qty" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Voucher_Number")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="lblInward_Qty" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"UserType")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="lblOutward_Qty" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"UserName")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="lblClosing_Qty" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Division")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="lblValue" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Source_Center_Name")%>' />
                        </td>
                         <td style="text-align: left;">
                         ...
                         <td style="text-align: left;">
                            <asp:Label ID="Label10" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Item_Code")%>' />
                        </td>
                         <td style="text-align: left;">
                            <asp:Label ID="Label12" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Item_Name")%>' />
                        </td>
                        <td style="text-align: left;">
                            <asp:Label ID="Label14" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Asset_No")%>' />
                        </td>
                         <td style="text-align: left;">
                            <asp:Label ID="Label3" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Approved_On")%>' />
                        </td>
                         <td style="text-align: left;">
                            <asp:Label ID="Label15" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Authorised_On")%>' />
                        </td>
                         <td style="text-align: left;">
                            <asp:Label ID="Label16" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Dispatch_to_replication")%>' />
                        </td>
                         <td style="text-align: left;">
                            <asp:Label ID="Label17" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"FG_Dispatch_to_Stores")%>' />
                        </td>
                         <td style="text-align: left;">
                            <asp:Label ID="Label19" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"dispatch_to_center")%>' />
                        </td>
                       </tr>
                    </ItemTemplate>
         </asp:Repeater>
