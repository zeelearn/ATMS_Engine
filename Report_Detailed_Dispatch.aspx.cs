...
public partial class Dispatch_Report_Mohit : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            lblMaterilaGroup.Text = ddlProductCat_SR.SelectedItem.ToString();
    ...
    private void FillGrid(string fromdate, string todate, string From_Location_Type_Code, string From_Location_Code)
    {
        ...
        {
            Clear_Error_Success_Box();
            DataSet dsGrid = ProductController.Dispatch_Report_Mohit(fromdate, todate, From_Location_Type_Code, From_Location_Code, ddlProductCat_SR.SelectedValue.ToString());
            if (dsGrid != null)
            {
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Dispatch_Report_Mohit" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='15'>Detailed Dispatch Report </b></TD><TR><TD Colspan='3'><b>Location Type : " + lblLocationType_Result.Text + "</b></TD><TD Colspan='3'><b>Location : " + lblLocationResult.Text + "</b></TD></tr><tr><TD Colspan='3'><b>Period : " + lblPeroidResult.Text + "</b></TD><TD Colspan='3'><b>Material Group : " + lblMaterilaGroup.Text + "</b></TD></TR></TR>");
        //HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='12'>Dispatch Report Mohit</b></TD></TR>");
        Response.Charset = "";
