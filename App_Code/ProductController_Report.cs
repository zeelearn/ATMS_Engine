...
namespace ShoppingCart.BL
{
    public class ProductController_Report
    {
        ...
        public static DataSet GetManageDispatchPrint(string Dispatch_code)
        {

            SqlParameter p1 = new SqlParameter("@Dispatch_code", SqlDbType.VarChar);
            p1.Value = Dispatch_code;

            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_GetData_ForPrint", p1));
        }
        public static DataSet GetPrint(int Flag, string Asset_No)
        {

            SqlParameter p1 = new SqlParameter("@Flag", SqlDbType.Int);
              p1.Value = Flag;
            SqlParameter p2 = new SqlParameter("@Asset_No", SqlDbType.VarChar);
       
            p2.Value = Asset_No;
          

            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_GetDetails_ForPrint", p1,p2));
        }
        public static DataSet Get_Datatoprint(int Flag,string Job_Id)
        {
            SqlParameter p1 = new SqlParameter("@flag", SqlDbType.Int);
             p1.Value = Flag;
             SqlParameter p2 = new SqlParameter("@Job_Id", SqlDbType.VarChar);
            p2.Value = Job_Id;

            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_GetDetails_ForPrint", p1,p2));
        }
        //for dispatch print opn 2
        public static DataSet Get_Datafordispatchprint(int Flag, string Job_Id)
        {
            SqlParameter p1 = new SqlParameter("@flag", SqlDbType.Int);
            p1.Value = Flag;
            SqlParameter p2 = new SqlParameter("@Job_Id", SqlDbType.VarChar);
            ...
            return (SqlHelper.ExecuteDataset(ConnectionString.GetConnectionString(), CommandType.StoredProcedure, "USP_GETDETAILS_PRINT_DISPATCH", p1, p2));
        }
    }
}
