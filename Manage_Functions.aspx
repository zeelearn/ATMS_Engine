<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Manage_Functions.aspx.cs" Inherits="Manage_Functions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">
                    Function Details <span class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
        ...
        <div class="row-fluid">
                                                    ...
                                                    <table cellpadding="0" style="border-style: none; width: 139%;" class="table-hover">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label13" runat="server">Function Name</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox ID="txtfunction" runat="server" Text="" Width="205px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="span6" style="text-align: left">
                                                    <table cellpadding="0" class="table-hover" style="border-style: none;" width="100%">
                                                        <tr>
                                                             <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label1" runat="server" CssClass="red">Function Name</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox ID="txtFunctionadd" runat="server" Text="" Width="205px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
            ...
            <div id="DivResultPanel" runat="server" visible="false">
                                ...
                                <asp:Repeater ID="dlGridDisplay" runat="server" 
                                    ...
                                    <ItemTemplate>
                                        <td>
                                            <asp:Label ID="lblMenuCode" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Function_Id")%>' />
                                        </td>
                                    
                                        <td id="Td1">
                                            <asp:Label ID="lblitemcode" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Function_Name")%>' />
                                        </td>
                                        ...
                                        <td style="text-align: center;">
                                            <div class="inline position-relative">
                                                <asp:LinkButton ID="lnkEdit" ToolTip="Edit" class="btn-small btn-primary icon-info-sign"
                                                    CommandArgument='<%#DataBinder.Eval(Container.DataItem,"Function_Id")%>' runat="server"
                                                ...
                                                <asp:LinkButton ID="lnkDLDelete" ToolTip="Remove" Visible="false" class="btn-small btn-danger icon-trash"
                                                    runat="server" CommandName="ItemRemove" Height="25px" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"Function_Id")%>' />&nbsp;
                                            </div>
                                        </td>
                                        </tr>
                                    </ItemTemplate>
                                ...
                                <asp:Repeater ID="dlFunctionExport" runat="server" Visible="false">
                                    <HeaderTemplate>
                                        <table class="table table-striped table-bordered table-hover ">
                                            <thead>
                                                <tr>
