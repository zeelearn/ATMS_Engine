<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="Item_FaultyDetails.aspx.cs" Inherits="Item_FaultyDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">
                    <asp:Label ID="lblHeader" runat="server" Text="">Item Faulty Details</asp:Label><span
                        class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper" visible="false">
                    ...
                    <ItemTemplate>
                        <tr class="odd gradeX">
                            ...
                            <td style="width: 11%; text-align: center;">
                                ...
                                <td style="width: 09%; text-align: center;">
                ...
                <asp:DataList ID="DataList1" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <ItemTemplate>
                                ...
                                <asp:Label ID="Label17" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Dispatch_Code" )%>' />
                            </td>
                                           ...
                                           <%--     <td class="span4" style="text-align: left">
                                                ...
                                                <%--<td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label43" runat="server" CssClass="red" Visible="false">Division</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                            ...
                                            <tr>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none; width: 100%;" class="table-hover">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label10" runat="server" CssClass="red">Vendor Name</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox ID="txtvendor" runat="server" Text="" Width="205px"></asp:TextBox>
                                                                <%-- <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="tb1"
            ValidationExpression="^[a-zA-Z0-9]+$" ErrorMessage="no special character"></asp:RegularExpressionValidator>--%>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <div id="DivForOP3" runat="server">
                                            <div class="widget-box">
                                                <div class="widget-header widget-header-small header-color-dark">
                                                    <h5>
                                                        <asp:Label ID="lblHeadingOP4" runat="server" Text=""></asp:Label>
                                                    </h5>
                                                </div>
                                                <div class="widget-body">
                                                    <div class="widget-body-inner">
                                                                    ...
                                                                    <td class="span4" style="text-align: left" colspan="3">
                                                                        <table cellpadding="0" class="table-hover" style="border-style: none; width: 100%;">
                                                                            <tr>
                                                                                ...
                                                                                <td style="border-style: none; text-align: left; width: 65%;">
                                                                                    <asp:TextBox ID="txtItemQty" runat="server" Text="" Width="150px" AutoPostBack="True"></asp:TextBox>
                                                                                    &nbsp;
                                ...
                                <div class="widget-main alert-block alert-success  alert- " style="text-align: center;">
                                    ...
                                    <asp:Button class="btn btn-app btn-success btn-mini radius-4" ID="btnPrint" runat="server"
                                        Text="Print" Visible="False" OnClientClick="SetTarget();" />
                                                ...
                                                <tr>
                                                    <td class="span4" style="text-align: left">
                                                        <table cellpadding="0" class="table-hover" style="border-style: none; width: 100%;">
                                                            <tr>
                                                                <td style="border-style: none; text-align: left; width: 40%;">
                                                                    <asp:Label ID="Label8" runat="server">Location Type</asp:Label>
                                                                </td>
                                                                <td style="border-style: none; text-align: left; width: 60%;">
                                                    ...
                                                    <td class="span4" style="text-align: left">
                                                        <table cellpadding="0" class="table-hover" style="border-style: none; width: 100%;">
                                                            <tr>
                                                                <td style="border-style: none; text-align: left; width: 40%;">
                                                                    <asp:Label ID="Label9" runat="server">Location</asp:Label>
                                                                </td>
                                                                <td style="border-style: none; text-align: left; width: 60%;">
