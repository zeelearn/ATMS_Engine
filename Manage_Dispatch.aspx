<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeFile="Manage_Dispatch.aspx.cs" Inherits="Manage_Dispatch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function openModalDivOverride2() {


            $('#DivOverrid1').modal('close');


        }
        function openModalDivOverride1() {

            $('#DivOverrid1').modal({
                backdrop: 'static'
            })

            $('#DivOverrid1').modal('show');
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="server">
    ...
    <div id="page-content" class="clearfix">
        ...
        <div class="row-fluid">
                    ...
                    <div class="widget-body">
                        <div class="widget-body-inner">
                            ...
                            <div class="widget-main alert-block alert-info" style="text-align: center;">
                                <!--Button Area -->
                                <asp:Button class="btn btn-app btn-warning  btn-mini radius-4" runat="server" Visible="false"
                                    ID="btnprintopt2" Text="Print" ToolTip="Print" ValidationGroup="UcValidateSearch"
                                    OnClick="btnprintopt2_Click" />
                                ...
                                <td style="width: 11%; text-align: center;">
                                    <div class="inline position-relative">
                                        ...
                                        <asp:LinkButton runat="server" ID="btnPrint" ToolTip="Print" class="btn-small btn-warning icon-2x icon-print"
                                            ...
                                            CommandName="print" Visible='<%#(string)DataBinder.Eval(Container.DataItem,"Is_visible") =="1" ? true : false%>' />
            ...
            <div id="DivPrintPanel" runat="server" class="dataTables_wrapper" visible="false">
                <asp:UpdatePanel ID="printupdatepanel" runat="server">
                    <ContentTemplate>
                        <div class="widget-box">
                            <div class="table-header">
                                <table width="100%">
                                    <tr>
                                        <td class="span10">
                                            Total No of Records:
                                            <asp:Label runat="server" ID="lbltotalrecordsprint" Text="0" />
                                        </td>
                                        <td style="text-align: right" class="span2">
                                            <asp:LinkButton runat="server" ID="btnexport02" ToolTip="Export" class="btn-small btn-danger icon-2x icon-download-alt"
                        ...
                        <asp:DataList ID="datalistprint" runat="server" Width="100%">
                            <HeaderTemplate>
                                    ...
                                    <thead>
                                        <tr>
                                            <td>
                                                ...
                                                <th style="width: 5%; text-align: center;" runat="server" visible="false">
                                                    Dispatch Code
                                                </th>
                                        </tr>
                                    </thead>
                            ...
                            <ItemTemplate>
                                ...
                                <td>
                                    <asp:Label ID="lblidispatchdate" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Dispatch_Date" ,"{0:dd MMM yyyy}" )%>' />
                                </td>
                                <td style="text-align: center;">
                                    <asp:Label ID="lblchallanno" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Challan_No")%>' />
                                </td>
                                <td style="text-align: center;">
                                    <asp:Label ID="lblcontatcperson" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"ContactPerson")%>' />
                                </td>
                                <td style="text-align: center;">
                                    <asp:Label ID="lbltotalitemcount" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Total_Item_Count")%>' />
                                </td>
                                <td style="text-align: center;">
                                    <asp:Label ID="lbltotalquantity" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Total_Quantity")%>' />
                                </td>
                                <td style="text-align: center;">
                                    <asp:Label ID="lbltotalamount" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Total_Amount")%>' />
                                </td>
                                <td style="text-align: center;" runat="server" visible="false">
                                    <asp:Label ID="lbldispatchcode" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Dispatch_Code")%>' />
                                </td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:DataList ID="datalistprintexcel" runat="server" Width="100%" Visible="false">
                            <HeaderTemplate>
                                <table class="table table-striped table-bordered table-hover ">
                                    <thead>
                                        <tr>
                ...
                <div class="widget-main alert-block alert-success  alert- " style="text-align: center;">
                    <!--Button Area -->
                    <asp:Button class="btn btn-app btn-success btn-mini radius-4" ID="Btprintgrid" runat="server"
                        Text="Print" OnClientClick="print" OnClick="Btprintgrid_Click" />
                    <%-- <asp:LinkButton runat="server" ID="btnPrint" ToolTip="Print" Height="25px" CommandName="print" 
                        OnClick="Btprint_Click" />--%>
                    <asp:Button ID="Button1" Visible="true" runat="server" class="btn btn-app btn-primary btn-mini radius-4"
                        Text="Close" OnClick="Button1_Click" />
                </div>
            </div>
                                        ...
                                        <table cellpadding="3" class="table table-striped table-bordered table-condensed">
                                            <tr>
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    ...
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%"
                                                        runat="server" id="Txtfromaddress_add" visible="false">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label47" runat="server" CssClass="red">Address</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox ID="Txtfromadd" runat="server" Text="" Width="205px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none; width: 100%;" class="table-hover"
                                                        runat="server" id="tblFR_statename_Add" visible="false">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Fromstate" runat="server" CssClass="red">From State</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList ID="DdlFR_STATENAME" runat="server" AutoPostBack="True" CssClass="chzn-select"
                                                                    data-placeholder="Select State Name" Width="215px" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    ...
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%"
                                                        runat="server" id="TXTtoaddress_add" visible="false">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Txttoaddress" runat="server" CssClass="red">Address</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox ID="TXTtoAdd" runat="server" Text="" Width="205px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none; width: 100%;" class="table-hover"
                                                        runat="server" id="TXTtosatename_add" visible="false">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="TOSTATE" runat="server" CssClass="red">To State</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList ID="DldTO_statename" runat="server" AutoPostBack="True" CssClass="chzn-select"
                                                                    data-placeholder="Select State Name" Width="215px" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr id="forOption2" runat="server" visible="false">
                                                <td class="span4" style="text-align: left">
                                                            ...
                                                            <table cellpadding="0" style="border-style: none; width: 100%;" class="table-hover">
                                                                <tr>
                                                                    ...
                                                                    Width="160px" />--%>
                                                                        ...
                                                                        <%-- <asp:Button ID="btnRequi_Search" class="btn  btn-app btn-primary btn-mini radius-4"
                                                                    runat="server" Text="Search" Width="50px" OnClick="btnRequi_Search_Click" />--%>
                                                                        <button runat="server" class="btn btn-info btn-small" style="height: 28px" id="btnRequi_Search"
                                                                            onserverclick="btnRequi_Search_Click" type="button">
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none; width: 100%;" class="table-hover">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label42" runat="server">User Type</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:Label ID="lblUserType" runat="server" Text=""></asp:Label>
                                                                &nbsp;&nbsp;
                                                                <asp:Label ID="lblreissue" CssClass="blue" runat="server"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="lblvoucher" runat="server" CssClass="red" Visible="false">Voucher Number</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:Label ID="lblvoucherno" runat="server" Text="" CssClass="blue"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none; width: 100%;" class="table-hover">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label28" runat="server" >Invoice No</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none; width: 100%;" class="table-hover">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label29" runat="server">Invoice Date</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                              <input readonly="readonly" class="span2.5 date-picker" id="txtInvoicedate" runat="server"
                                                                        type="text" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label32" runat="server" >PO Number</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox ID="txtPonumber_Add" runat="server" Text="" Width="205px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none; width: 100%;" class="table-hover">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label48" runat="server">PO Date</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                               <input readonly="readonly" class="span2.5 date-picker" id="txtpodate" runat="server"
                                                                        type="text" />
                                            ...
                                            <tr>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none; width: 100%;" class="table-hover">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label30" runat="server" CssClass="red">Contact Person.</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none; width: 100%;" class="table-hover">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label31" runat="server">Contact No</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox ID="txtContno_Add" runat="server" Text="" Width="205px"></asp:TextBox>
                                                            </td>
                                                            &nbsp;
                                                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" FilterType="Numbers,Custom"
                                                                                        TargetControlID="txtContno_Add" />
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td class="span4" style="text-align: left">
                                                        ...
                                                        <div class="widget-main">
                                                            <asp:DataList ID="datalist_Student" CssClass="table table-striped table-bordered table-hover"
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <td style="text-align: center;">
                                                                        <asp:Label ID="Label43" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Source_Center_Name")%>' />
                                                                    </td>
                                                                    <td style="text-align: center;">
                                                                    ...
                                                                    <td style="text-align: center;">
                                                                        <asp:Label ID="Label45" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Status")%>' />
                                                                    </td>
                                                                    <td style="text-align: left;">
                                                        ...
                                                        <div class="widget-main">
                                                            <asp:DataList ID="DTOP3" CssClass="table table-striped table-bordered table-hover"
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <td style="width: 10%; text-align: center;">
                                                                        <asp:Label ID="Label46" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Source_Center_Name")%>' />
                                                                    </td>
                                                                    <td style="width: 10%; text-align: center;">
                                                                        ...
                                                                        <table cellpadding="0" style="border-style: none; width: 100%;" class="table-hover">
                                                                            <tr>
                                                                                ...
                                                                                <td style="border-style: none; text-align: left; width: 65%;">
                                                                                    ...
                                                                                    <asp:Label ID="lblqty" runat="server" Text="1" Visible="false"></asp:Label>
                                                                    ...
                                                                    <td class="span4" style="text-align: left" colspan="3">
                                                                        <table cellpadding="0" class="table-hover" style="border-style: none; width: 100%;">
                                                                            <tr>
                                                                                ...
                                                                                <td style="border-style: none; text-align: left; width: 65%;">
                                                                                    <asp:TextBox ID="txtItemQty" runat="server" Text="1" Width="150px" OnTextChanged="txtItemQty_TextChanged"
                                                                ...
                                                                <tr>
                                                                    <td class="span4" style="text-align: left" colspan="3">
                                                                        <table cellpadding="0" class="table-hover" style="border-style: none; width: 100%;">
                                                                            <tr>
                                                                                <td style="border-style: none; text-align: left; width: 35%;">
                                                                                    <asp:Label ID="Label64" CssClass="red" runat="server">Rate</asp:Label>
                                                                                </td>
                                                                                <td style="border-style: none; text-align: left; width: 65%;">
                                                                                <asp:TextBox ID="txtItemRate" runat="server"  Width="150px" OnTextChanged="txtItemQty_TextChanged" AutoPostBack="True"></asp:TextBox>
                                                                                 &nbsp;
                                                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Numbers,Custom"
                                                                                        ValidChars="." TargetControlID="txtItemRate" />
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="border-style: none; text-align: left; width: 65%;">
                                                                                    ...
                                                                                    <button class="btn btn-info btn-mini radius-4" id="btnSaveItem" runat="server" style="height: 28px"
                                                                                        validationgroup="UcValidate" title="Add Material Qty " onserverclick="btnSaveItem_ServerClick"
                                                                                        type="button">
                                                                                        <i class="icon-plus"></i>
                                                                                    </button>
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <td style="width: 20%; text-align: center;">
                                                                        ...
                                                                        <asp:Label ID="Inward_Qty" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Inward_Qty")%>'
                                                                            Visible="false" />
                                                                        <asp:Label ID="lblis_Acknowledged" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"is_Acknowledged")%>'
                                                                            Visible="false" />
                                                                        <asp:Label ID="lblRequestEntry_Code_Grid" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Request_EntryCode")%>'
                                                                            Visible="false" />
                                                                    </td>
                                                                    ...
                                                                    <td style="width: 15%; text-align: center;">
                                                                        <asp:LinkButton ID="lnkRemove" ToolTip="Remove" class="btn-small btn-danger icon-trash"
                                                                            ...
                                                                            Visible='<%#(string)DataBinder.Eval(Container.DataItem,"is_Acknowledged") =="0" ? true : false%>' />
                                                                </ItemTemplate>
                                                            </asp:DataList>
                                                ...
                                                <div class="widget-body-inner">
                                                    <div class="widget-main">
                                                        <td class="span12" style="text-align: left">
                                                            <table cellpadding="0" style="border-style: none;" class="table-hover" width="65%">
                                                                <tr>
                                                                    <asp:DataList ID="dsTAX" CssClass="table table-striped table-bordered table-hover"
                                                                        runat="server" Width="98%" Height="250px">
                                                                        <HeaderTemplate>
                                                                    ...
                                                                    <tr>
                                                                        <td class="span6" style="text-align: left">
                                                                            <table cellpadding="0" class="table-hover" style="border-style: none; width: 100%;">
                                                                                <tr>
                                                                                    <td style="border-style: none; text-align: left; width: 40%;">
                                                                                        <asp:Label ID="Label51" runat="server" >LR/TR Note</asp:Label>
                                                                                    </td>
                                                                                    <td style="border-style: none; text-align: left; width: 60%;">
                                                                                     <asp:TextBox ID="TxtLRTRnote" runat="server" Text="" Width="205px"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                    ...
                                                    <div class="widget-body">
                                                        <div class="widget-main ">
                                                            <asp:DataList ID="dlItemListAuthorise" CssClass="table table-striped table-bordered table-hover"
                                                                ...
                                                                <HeaderTemplate>
                                                                    <asp:CheckBox ID="chkAttendanceAll" runat="server" AutoPostBack="True" OnCheckedChanged="chkAuthorise_CheckedChanged" />
                                                                    <span class="lbl"></span></th>
                                                                    <th style="width: 10%; text-align: center;">
                                                                        Material Code
                                                                    </th>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="modal fade" id="DivOverrid" style="left: 40% !important; top: 10% !important;
                display: none; width: 65%" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                                        ...
                                        <asp:DataList ID="DataList3" runat="server" CssClass="table table-striped table-bordered table-hover"
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:Label ID="lblitemcode" runat="server" Visible="false" Text='<%#DataBinder.Eval(Container.DataItem,"Item_Code")%>' />
                                                </td>
                                                <td>
                        ...
                        <div class="modal-footer">
                            ...
                            <%-- <asp:Button class="btn btn-app  btn-success btn-mini radius-4" 
                                ID="btnclickok" ToolTip="OK" runat="server" Text="OK" OnClick="btnclickok_Click" />--%>
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="dladditem" />
        </Triggers>
    </asp:UpdatePanel>
    <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="modal fade" id="DivOverrid1" style="left: 40% !important; top: 10% !important;
                display: none; width: 65%" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                                ...
                                <tr>
                                    <td style="border-style: none; text-align: left; width: 90%;" colspan="3">
                                        <asp:DataList ID="dladditem" runat="server" CssClass="table table-striped table-bordered table-hover"
                                            Width="97%" OnItemCommand="dladditem_ItemCommand">
                                            <HeaderTemplate>
                                                <asp:CheckBox ID="chkAttendanceAll" runat="server" AutoPostBack="True" OnCheckedChanged="chkItem_CheckedChanged" />
                                                <span class="lbl"></span></th>
                                                <th>
                                                    <b>Material Code</b>
                                                </th>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <td>
                                                    <asp:Label ID="lblDLItemUnit" runat="server" Visible="true" Text='<%#DataBinder.Eval(Container.DataItem,"UOM_Name")%>' />
                                                    <asp:Label ID="lblitemcode" runat="server" Visible="false" Text='<%#DataBinder.Eval(Container.DataItem,"Pkey")%>' />
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblAsset_No" runat="server" Visible="true" Text='<%#DataBinder.Eval(Container.DataItem,"Asset_No")%>' />
                                                </td>
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button class="btn btn-app  btn-success btn-mini radius-4" ID="btnadditem" ToolTip="OK"
                                runat="server" Text="OK" OnClick="btnadditem_Click" OnClientClick="window.close();" />
                            <asp:Button class="btn btn-app btn-primary btn-mini radius-4" data-dismiss="modal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        &times;</button>
                    <h4 class="modal-title" cssclass="red" style="color: #FF0000">
                        Warning
                    </h4>
                </div>
                <div class="modal-body">
