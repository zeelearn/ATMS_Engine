...
public partial class Manage_Dispatch : System.Web.UI.Page
{
    ...
    private void ClearAddPanel()
    {
        ...
        Txtfromadd.Text = "";
        DdlFR_STATENAME.SelectedIndex = 0;
        TXTtoAdd.Text = "";
        DldTO_statename.SelectedIndex = 0;
        txtinvoiceNo_Add.Text = "";
        txtInvoicedate.Value = "";
        txtPonumber_Add.Text = "";
        txtpodate.Value = "";
        txtContact_Add.Text = "";
        txtContno_Add.Text = "";
        TxtLRTRnote.Text = "";
        ...
        //txtChallanNo_Add.Text = ""; need to check
        ...
        txtContno_Add.Text = "";
        //txtContactPerson_Add.Text = ""; need to check
        txtContact_Add.Text = "";
        //txtChallanDate_Add.Text = DateTime.Now.ToString("dd-MMM-yyyy"); need to check
    ...
    private void SaveData()
    {
        try
        {
            ...
            if (DdlFR_STATENAME.SelectedValue == "Select State Name")
            {

                Show_Error_Success_Box("E", "select From State");
                return;
                
            }


            if (DldTO_statename.SelectedValue == "Select State Name")
            {

                Show_Error_Success_Box("E", "select To State");
                return;
                
            }


            if (txtContact_Add.Text == "")
            {
                Show_Error_Success_Box("E", "Add Contact Person Name");
                return;
            }

            if(ddlLogisticType_Add.SelectedValue=="Select Logistic")
            {
            ...
            //if (TotalRecord == 0)
            //{
            //    Show_Error_Success_Box("E", "You have not Selected any TAX Details");
            //    return;
            //}
            ...
            //Challan_No = txtChallanNo_Add.Text.Trim(); need to check
            //Challan_Date = Convert.ToDateTime(txtChallanDate_Add.Text.Trim()); need to check
            //ContactPerson = txtContactPerson_Add.Text.Trim(); need to check
            ContactPersonNo = txtContno_Add.Text.Trim();
            ContactPerson = txtContact_Add.Text.Trim();
            ...
            //, To_Location_Code, Dispatch_Date, Challan_No, Dispatch_Date, //Challan_Date need to check,
            //ContactPerson, ContactPersonNo, ContactPersonEmailId, Total_Item_Count
            //, Total_Quantity, Total_Amount, 1, LogisticType_Code, LogisticDetails1, LogisticDetails2, IsActive, CreatedBy, "", "", "");



            ResultId = ProductController.Insert_Update_Dispach(2, "", From_Location_Type_Code, From_Location_Code, To_Location_Type_Code
            , To_Location_Code, Txtfromadd.Text, TXTtoAdd.Text, DdlFR_STATENAME.SelectedValue, DldTO_statename.SelectedValue, ContactPerson, ContactPersonNo, ContactPersonEmailId, Total_Item_Count
            , Total_Quantity, Total_Amount, 1, LogisticType_Code, LogisticDetails1, LogisticDetails2, IsActive, CreatedBy, "", "", "", taxcode, TxtLRTRnote.Text, txtinvoiceNo_Add.Text, txtInvoicedate.Value, txtPonumber_Add.Text, txtpodate.Value);
    ...
    private void UpdateData()
    {
        try
        {
            ...
            //ContactPerson = txtContactPerson_Add.Text.Trim(); need to check
            ContactPersonNo = txtContno_Add.Text.Trim();
            ContactPerson = txtContact_Add.Text;
            LogisticType_Code = ddlLogisticType_Add.SelectedValue;
            ...
            , To_Location_Code, Txtfromadd.Text, TXTtoAdd.Text, DdlFR_STATENAME.SelectedValue, DldTO_statename.SelectedValue,
            //Dispatch_Date, Challan_No, Dispatch_Date,
            //Challan_Date need check, 
            ContactPerson, ContactPersonNo, ContactPersonEmailId, Total_Item_Count
            , Total_Quantity, Total_Amount, 1, LogisticType_Code, LogisticDetails1, LogisticDetails2, IsActive, CreatedBy, "", "", "", taxcode, "","","","","");
            ...
            else
            {
                ...
                foreach (DataListItem item in DataList2.Items)
                {
                    if (item.ItemType == ListItemType.Item | item.ItemType == ListItemType.AlternatingItem)
                    {
                        ...
                        //if (a != "1")----COMIITED BY SUJEER FOR WROUNG CURRENT QUNTY UPDATE WHILE EDITING THE DATA.
                        //{
    ...
    private void SaveDataForOptionCode(string UserType)
    {
        try
        {
            ...
            //Challan_Date = Convert.ToDateTime(txtChallanDate_Add.Text.Trim()); need to check
            ContactPerson = txtContact_Add.Text.Trim();
            //ContactPersonEmailId = txtContno_Add.Text.Trim();
            ContactPersonNo = txtContno_Add.Text.Trim();
            LogisticType_Code = ddlLogisticType_Add.SelectedValue;
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            ds = ProductController.Get_Dispatch_Item(5, Challan_No, From_Location_Type_Code, From_Location_Code, To_Location_Code, To_Location_Type_Code, FromDate, ToDate);
        }
    ...
    protected void btnSaveItem_ServerClick(object sender, EventArgs e)
    {
        ...
        if (txtItemQty.Text.Trim() == "" || txtItemQty.Text.Trim() == "0")
        {
        ...
        //{
        //    Show_Error_Success_Box("E", "Item Quntity Can't Be '0' ");
        //    return;
        //}
        ...
        {
            Show_Error_Success_Box("E", "ADD  Rate");
            //txtItemQty.Focus();
            return;
        }
    ...
    protected void btnSearchItem_ServerClick(object sender, EventArgs e)
    {
        ...
        if (dsSupplier.Tables[0].Rows.Count > 0)
        {
            if (dsSupplier.Tables[0].Rows.Count == 1)
            {
                ...
                {
                    //Rate1 = 0;
                    Show_Error_Success_Box("E", "Kindly Add Rate");
                    return;
                }
                else
                {
    ...
    protected void dlGridDisplay_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "comEdit")
        {
            ...
            {
                //txtChallanNo_Add.Text = ds1.Tables[0].Rows[0]["Challan_No"].ToString(); need to check
                // txtChallanDate_Add.Text = Convert.ToDateTime(ds1.Tables[0].Rows[0]["Challan_Date"].ToString()).ToString("dd-MMM-yyyy"); need to check
               //txtContno_Add.Text = ds1.Tables[0].Rows[0]["ContactPersonEmailId"].ToString();
                //txtContactPerson_Add.Text = ds1.Tables[0].Rows[0]["ContactPerson"].ToString(); need to check
                txtContact_Add.Text = ds1.Tables[0].Rows[0]["ContactPerson"].ToString();
                txtContno_Add.Text = ds1.Tables[0].Rows[0]["ContactPersonNo"].ToString();
                ...
                txtLogisticDetails_Add.Text = ds1.Tables[0].Rows[0]["LogisticDetails1"].ToString();
                //FillDDL_Tax();
                //for (int cnt = 0; cnt <= ds1.Tables[6].Rows.Count - 1; cnt++)
                //{
                ...
                //        CheckBox chkitemck = (CheckBox)dtlItem.FindControl("chkCheck");
                //        Label lbltaxcode = (Label)dtlItem.FindControl("lbltaxcode");
                //        if (Convert.ToString(lbltaxcode.Text).Trim() == Convert.ToString(ds1.Tables[6].Rows[cnt]["Tax_code"]).Trim())
                //        {
                ...
                if (ds1.Tables[6].Rows.Count > 0)
                {
                    ...
                    btnPrint.Visible = false;
                    Show_Error_Success_Box("S", "Print Option Is Not Available As Dispatch Acknowledgment Is Pending");
                ...
                if (ddlTransferFR_Add.SelectedItem.ToString().Trim() == "Godown")
                {
                    ...
                    tblFR_Division_Add.Visible = false;
                    tblFR_Center_Add.Visible = false;
                    Txtfromaddress_add.Visible = true;
                    tblFR_statename_Add.Visible = true;
                    FillDDL_state();
                    DdlFR_STATENAME.SelectedValue = ds1.Tables[0].Rows[0]["FROMSTATECODE"].ToString();
                    Txtfromadd.Text = ds1.Tables[0].Rows[0]["FROMADDRESS"].ToString();
                ...
                else if (ddlTransferFR_Add.SelectedItem.ToString().Trim() == "Center")
                {
                    ...
                    tblFR_Function_Add.Visible = false;
                    tblFR_Godown_Add.Visible = false;
                    Txtfromaddress_add.Visible = false;
                    tblFR_statename_Add.Visible = true;
                    FillDDL_state();
                ...
                else if (ddlTransferFR_Add.SelectedIndex == 0 || ddlTransferFR_Add.SelectedIndex == -1)
                {
                    ...
                    tblFR_Center_Add.Visible = false;
                    Txtfromaddress_add.Visible = false;
                    tblFR_statename_Add.Visible = false;
                }
                ...
                if (ddlTransferTO_Add.SelectedItem.ToString().Trim() == "Godown")
                {
                    ...
                    tblTO_Division_Add.Visible = false;
                    tblTO_Center_Add.Visible = false;
                    TXTtoaddress_add.Visible = true;
                    TXTtosatename_add.Visible = true;
                    FillDDL_stateedit();
                    DldTO_statename.SelectedValue = ds1.Tables[0].Rows[0]["TOSTATE"].ToString();
                    TXTtoAdd.Text = ds1.Tables[0].Rows[0]["TOADDRES"].ToString();
                ...
                else if (ddlTransferTO_Add.SelectedItem.ToString().Trim() == "Center")
                {
                    ...
                    tblTO_Function_Add.Visible = false;
                    tblTO_Godown_Add.Visible = false;
                    TXTtoaddress_add.Visible = false;
                    TXTtosatename_add.Visible = true;
                    FillDDL_stateedit();
    ...
    protected void ddlTransferTO_Add_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else if (ddlTransferTO_Add.SelectedIndex == 0 || ddlTransferTO_SR.SelectedIndex == -1)
        {
            ...
            tblTO_Center_Add.Visible = false;
            TXTtoaddress_add.Visible = false;
            TXTtosatename_add.Visible = false;
        }
    }
    ...
    private bool ControlValidation()
    {
        ...
        //else if (txtContactPerson_Add.Text.Trim() == "") need to check
        //{
    ...
    {
       // ddlLogisticType_Add.Items.Clear();
        DataSet dsstate = ProductController.Get_State(13);
        BindDDL(DdlFR_STATENAME, dsstate, "State_Name", "State_Code");
        DdlFR_STATENAME.Items.Insert(0, "Select State Name");
        DdlFR_STATENAME.SelectedIndex = 0;

        //ddlLogisticType_Add.Items.Clear();
        DataSet dstate = ProductController.Get_State(13);
        BindDDL(DldTO_statename, dstate, "State_Name", "State_Code");
        DldTO_statename.Items.Insert(0, "Select State Name");
        DldTO_statename.SelectedIndex = 0;
    }

    private void FillDDL_stateedit()
    {
               //ddlLogisticType_Add.Items.Clear();
        DataSet dstate = ProductController.Get_State(13);
        BindDDL(DldTO_statename, dstate, "State_Name", "State_Code");
    ...
    //{
    //    DataSet ds = ProductController.gettax(14);

    //    dsTAX.DataSource = ds;
    //    dsTAX.DataBind();
    //    divtax.Visible = true;
    //    Label49.Text = " TAX Details ";
    //}
