...
public partial class ItemRequisition : System.Web.UI.Page
{
    ...
    protected void btnshow_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataSet Ds = ProductController.GetStudentDetails(Division, center, CP, Acad, 13,"","","");
    ...
    protected void btnSave_ForStudent_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ResultId = ProductController.Insert_ItemRequsition(1, UserID, ddlUserType.SelectedValue.ToString().Trim(), Division, center, Acad, CP, ItemCode, UserID, "");
            ...
            else
            {
                ...
                foreach (RepeaterItem dtlItem in datalist_Student.Items)
                {
                    ...
                    if (chkCheck.Checked == true && chkCheck.Visible == true)
                    {
                        Label lblSbentryCode = (Label)dtlItem.FindControl("lblStudentCode");

                        ResultId1 = ProductController.Insert_ItemRequsition_items(2, ResultId, lblSbentryCode.Text.Trim(), "", "", "", "");
                        if (ResultId1 == "1")
                        {
            ...
            if (Ds != null)
            {
                if (Ds.Tables.Count != 0)
                {
                    if (Ds.Tables[0].Rows.Count != 0)
                    {
                        ...
                        lbltotalrecords1.Text = (Ds.Tables[0].Rows.Count).ToString();
                    }
                    else
                    {
                        datalist_Teacher.DataSource = null;
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataSet Ds = ProductController.GetSearchRequisition(UserType, Division, FromDate, ToDate, OrderNO, 2);
                ...
                else if (lblUserType.Text == "UT003")
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (DsGrid.Tables[0].Rows.Count > 0)
                        {
                            ...
                            datalist_Teacher.DataBind();
                            divteacher.Visible = true;
                            lbltotalrecords1.Text = (DsGrid.Tables[0].Rows.Count).ToString();
                        }
                        else
                        {
                            datalist_Teacher.DataSource = null;
            ...
            else if (ResultId == "1")
            {
                ...
                foreach (RepeaterItem dtlItem in datalist_Student.Items)
                {
                    ...
                    if (chkCheck.Checked == true)
                    {
                        ...
                        ResultId1 = ProductController.Insert_ItemRequsition_items(2, RequestCode, lblSbentryCode.Text.Trim(), "", "", "", "");
                        if (ResultId1 == "1")
                        {
    ...
    protected void btnSave_forTeacher_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ResultId = ProductController.Insert_ItemRequsition(1, UserID, ddlUserType.SelectedValue.ToString().Trim(), Division, "", Acad, "", "", UserID, Remark);
            ...
            else
            {
                ...
                foreach (RepeaterItem dtlItem in datalist_Teacher.Items)
                {
                    ...
                    if (chkCheck.Checked == true)
                    {
                        ...
                        ResultId1 = ProductController.Insert_ItemRequsition_items(2, ResultId, lblPartnerCodeDL.Text.Trim(), "", "", "", "");
                        if (ResultId1 == "1")
                        {
            ...
            else if (ResultId == "1")
            {
                ...
                foreach (RepeaterItem dtlItem in datalist_Teacher.Items)
                {
                    ...
                    if (chkCheck.Checked == true)
                    {
                        ...
                        ResultId1 = ProductController.Insert_ItemRequsition_items(2, RequestCode, lblPartnerCodeDL.Text.Trim(), "", "", "", "");
                        if (ResultId1 == "1")
                        {
    ...
    protected void btnSave_ForEmp_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ResultId = ProductController.Insert_ItemRequsition(1, UserID, ddlUserType.SelectedValue.ToString().Trim(), ddlLocationType.SelectedValue.ToString().Trim(), Transfer_LocationCode, "", "", "", UserID, Remark);
            ...
            else
            {
                ...
                ResultId1 = ProductController.Insert_ItemRequsition_items(2, ResultId, ddlUserType.SelectedValue.ToString().Trim(), EMpName, EMPCode, EmailId, Status);
                if (ResultId1 == "1")
                {
                    Clear_Error_Success_Box();
                    BtnSearch_Click(this, e);
    ...
    protected void btnSaveEdit_ForEmp_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else if (ResultId == "1")
            {
                ...
                ResultId1 = ProductController.Insert_ItemRequsition_items(2, RequestCode, ddlUserType.SelectedValue.ToString().Trim(), EMpName, EMPCode, EmailId, Status);
                if (ResultId1 == "1")
                {
                    Clear_Error_Success_Box();
                    BtnSearch_Click(this, e);
    ...
    
    {
        ...
        DataSet Ds = ProductController.GetStudent_fornewrequest(Division, center, CP, Acad, 14, studentname, sbentrycode);
