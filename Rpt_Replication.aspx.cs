...
public partial class Rpt_Replication : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            DataSet dsGrid = ProductController.Get_Report_ReplicationDetails(ddlLocationType.SelectedValue.ToString(), Transfer_LocationCode, FromDate, ToDate);
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Rpt_replication_details_" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='17'>Reoprt Replication Details</b></TD><TR><TD Colspan='6'><b>Location Type : " + lblLocationType_Result.Text + "</b></TD><TD Colspan='11'><b>Location : " + lblLocationResult.Text + "</b></TD></tr><tr><TD Colspan='6'><b>Period : " + lblPeroidResult.Text + "</b></TD></TR></TR>");
        Response.Charset = "";
