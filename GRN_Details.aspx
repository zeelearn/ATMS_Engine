<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="GRN_Details.aspx.cs" Inherits="GRN_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">
                    GRN Details<span class="divider"></span></h4>
            </li>
        </ul>
        <!--#nav-search-->
    </div>
                    ...
                    <div class="widget-body">
                                                    ...
                                                    <table cellpadding="0" class="table-hover" style="border-style: none;" width="100%">
                                                        <tr>
                                                            <td class="span2" style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="lbltrensfertype" runat="server" CssClass="red">Location</asp:Label>
                                                            </td>
                        ...
                        <div class="widget-main alert-block alert-success  alert- " style="text-align: center;">
                            ...
                            <asp:Button class="btn btn-app btn-success btn-mini radius-4" ID="BtnSaveUpdate"
                                runat="server" Text="Save" ValidationGroup="UcValidate"  />--%>
                            <%--<div class="row-fluid">
