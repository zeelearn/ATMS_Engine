...
public partial class PO_Report : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataSet dsGrid = ProductController.Purchase_Order_Report(FromDate, ToDate);
            if (dsGrid != null)
            {
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Purchase_Order_Report" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='18'>Purchase Order Report</b></TD><TR><TD Colspan='12'><b>Period : " + lblPeroidResult.Text + "</b></TD></tr></TR>");
