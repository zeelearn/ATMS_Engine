...
public partial class Rpt_Asset_Tracking_Register : System.Web.UI.Page
{
    ...
    protected void BtnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (txtatms_assetno.Text != "")
            {
                lblassetno.Text=txtatms_assetno.Text;
            }
    ...
    private void FillGrid(string fromdate, string todate, string From_Location_Type_Code, string From_Location_Code)
    {
        ...
        {
            Clear_Error_Success_Box();
            DataSet dsGrid = ProductController.Asset_TrackingRegister_Report(fromdate, todate, From_Location_Type_Code, From_Location_Code, txtatms_assetno.Text);
            if (dsGrid != null)
            {
    ...
    protected void HLExport_Click(object sender, EventArgs e)
    {
        ...
        string filenamexls1 = "Asset_Tracking_Register_Report" + DateTime.Now + ".xls";
        ...
        HttpContext.Current.Response.Write("<Table border='1'  borderColor='#000000' cellSpacing='0' cellPadding='0' style='font-size:10.0pt; font-family:Calibri; text-align:center;'> <TR style='color: #fff; background: black;text-align:center;'><TD Colspan='14'>Asset Tracking Register</b></TD><TR><TD Colspan='7'><b>Location Type : " + lblLocationType_Result.Text + "</b></TD><TD Colspan='7'><b>Location : " + lblLocationResult.Text + "</b></TD></tr><tr><TD Colspan='7'><b>Period : " + lblPeroidResult.Text + "</b></TD><TD Colspan='7'><b>SAP AssetNo : " + lblassetno.Text + "</b></TD></TR></TR>");
